...
impl ConfigStore {
    ...
    pub fn check_updates_at_startup(&self) -> bool {
        self.data.check_updates_at_startup
    }

    pub fn set_check_updates_at_startup(&mut self, value: bool) {
        self.data.check_updates_at_startup = value;
    }
